...
import com.interview.datastructure.tree.TreeCommonQuestions;
...
public class InterviewQuestions {
    ...
    public static int sumTreePath(TreeNode root, int sum) {
    	if (root == null) {
    		return 0;
    	}
    	...
    	if (root.getLeft()==null&&root.getRight()==null) {
    		...
    		return sumTreePath(root.getLeft(), sum) + sumTreePath(root.getRight(), sum);
    	}
    }
    ...
    public static void main(String[] args) {
    	...
    	TreeNode root = TreeCommonQuestions.convertSortedArrayToBST(new int[]{1,2,3,4,5});
    	System.out.println(InterviewQuestions.sumTreePath(root, 0));
